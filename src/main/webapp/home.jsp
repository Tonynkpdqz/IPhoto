        ...
        <c:when test="${status.first or status.index % 4 eq 0}">
            ...
            <div class="col-xs-2 col-xs-offset-2">
                <a href="#" class="thumbnail text-center">
                    <img name="${image.name}" date="<fmt:formatDate value='${image.date}' pattern='yyyy-MM-dd HH:mm'/>" style="width: 140px; height: 130px;" src="http://oxbwz5ptu.bkt.clouddn.com/${image.url}"><!--这里请填写自己的链接地址，详见下图-->
    ...
    $(document).ready(function() {
        ...
        $('#upload').click(function() {
            if ($('#image_name').val() == '' || $('#image').val() == '') {
                ...
                $('#form').attr('action', '/UserAction/upload.html');
        ...
        //点击确定退出
        $('#exit').click(function() {
            $.get('/UserAction/exit.html', function(data, status) {
