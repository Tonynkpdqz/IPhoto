...
<div class="container">
    ...
    <form id="form" action="/UserAction/login.html" method="post" class="form-horizontal" role="form" style="margin-top: 73px;">
...
<form action="/UserAction/dologin.html" method="post">
    <table>
        <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#login').click(function() {
            //提交登录表单
            $.post('${pageContext.request.contextPath}' +'/UserAction/login.html',
                {
        ...
        $('#register').click(function() {
            //提交注册表单
            $.post('${pageContext.request.contextPath}' + '/UserAction/register.html',
                {
