    ...
    $(document).ready(function() {
        ...
        $('#upload').click(function() {
            if ($('#image_name').val() == '' || $('#image').val() == '') {
                ...
                $('#form').attr('action', '${pageContext.request.contextPath}' + '/UserAction/upload.html');
        ...
        //点击确定退出
        $('#exit').click(function() {
            $.get('${pageContext.request.contextPath}' + '/UserAction/exit.html', function(data, status) {
        ...
        $('#delete').click(function() {
            ...
            $.post('${pageContext.request.contextPath}' + '/UserAction/delete.html', {
                ids: ids,
                urls: urls
